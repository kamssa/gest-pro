...
import {RetraitBanqueActions, BanqueActionsTypes} from './retrait-banque.actions';
...
export function retraitBanqueReducer(state= initState, action: Action): BanqueState {
  switch (action.type) {
    ...
    case BanqueActionsTypes.GET_ALL_BANQUE_SUCCESS:
      return {...state, dataState: BanqueStateEnum.LOADED, banques: (action as RetraitBanqueActions).payload['body']};
    case BanqueActionsTypes.GET_ALL_BANQUE_ERROR:
      return {...state, dataState: BanqueStateEnum.ERROR, errorMessage: (action as RetraitBanqueActions).payload['message']};
    ...
    case BanqueActionsTypes.SAVE_BANQUE_SUCCESS:
      ...
      deps.push((action as RetraitBanqueActions).payload['body']);
      return {...state, dataState: BanqueStateEnum.LOADED, banques: deps};
    case BanqueActionsTypes.SAVE_BANQUE_ERROR:
      return {...state, dataState: BanqueStateEnum.ERROR, errorMessage: (action as RetraitBanqueActions).payload['messages']};

    /* Delete Products*/
    case BanqueActionsTypes.DELETE_BANQUE:
      return {...state, dataState: BanqueStateEnum.LOADING};
    case BanqueActionsTypes.DELETE_BANQUE_SUCCESS:
      const dep: Banque = (action as RetraitBanqueActions).payload['body'];
    ...
    case BanqueActionsTypes.DELETE_BANQUE_ERROR:
      return {...state, dataState: BanqueStateEnum.ERROR, errorMessage: (action as RetraitBanqueActions).payload['']};

    /* Update  Departement*/
    case BanqueActionsTypes.UPDATE_BANQUE:
      return {...state, dataState: BanqueStateEnum.LOADING };
    case BanqueActionsTypes.UPDATE_BANQUE_SUCCESS:
      const updateDepartement: Banque = (action as RetraitBanqueActions).payload['body'];
